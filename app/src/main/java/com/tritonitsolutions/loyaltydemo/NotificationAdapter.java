...
public class NotificationAdapter extends BaseAdapter {
    ...
    public NotificationAdapter(Context context,ArrayList<HashMap<String,String>> data_notification){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            vi=inflater.inflate(R.layout.notification_row,parent,false);
        ...
        holder.title.setText(notifi.get(NotificationActivity.TITLE));
        holder.description.setText(notifi.get(NotificationActivity.DESCRIPTION));
        //holder.coupon_code.setText(notifi.get(NotificationActivity.COUPON_CODE));
        holder.expire_date.setText(notifi.get(NotificationActivity.EXPIRE_DATE));
       // int i=Integer.parseInt(notifi.get(NotificationActivity.NOTIFICATION_ID));
